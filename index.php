                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <h5 align="center">SISTEMA DE GESTION DE ESTUDIANTES</h5>
                                    ...
                                    <form class="user" method="Post" action="">
                                        <div class="form-group">
                                            <select required name="userType" class="form-control mb-3">
                                                ...
                                                <!--option value="ClassTeacher">Profesor</option-->
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" required name="username" id="exampleInputEmail" placeholder="Ingrese su correo electrónico">
                                        </div>
                                        <div class="form-group">
