      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Crear Carrera</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        <label class="form-control-label">Nombre Carrera<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="className" value="<?php echo $row['className']; ?>"
                          id="exampleInputFirstName" placeholder="Nombre Carrera">
                      </div>
                    </div>
                    <?php
                    if (isset($Id)) {
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Todas las Carreras</h6>
                    </div>
                          ...
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              <tr>
                                ...
                                <td><a href='?action=edit&Id=" . $rows['Id'] . "'><i class='fas fa-fw fa-edit'></i>Editar</a></td>
                                <td><a href='?action=delete&Id=" . $rows['Id'] . "'><i class='fas fa-fw fa-trash'></i>Eliminar</a></td>
                              </tr>";
                            }
                          } else {
                            echo
