      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Crear Grado</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Crear Grado</h6>
                  <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        <label class="form-control-label">Selecionar Carrera<span class="text-danger ml-2">*</span></label>
                        <?php
                        ...
                        if ($num > 0) {
                          ...
                          echo '<option value="">--Selecionar Carrera--</option>';
                      ...
                      <div class="col-xl-6">
                        <label class="form-control-label">Nombre Grado<span class="text-danger ml-2">*</span></label>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Todos los Grados</h6>
                    </div>
